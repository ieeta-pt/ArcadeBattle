...
function setup()
{
    ...
    img = loadImage("games/assets/quiz/quiz_initial.png");
    start_btn = loadImage('games/assets/quiz/start_button.png');
    a_btn = loadImage('games/assets/quiz/A_option.png');
    b_btn = loadImage('games/assets/quiz/B_option.png');
    x_btn = loadImage('games/assets/quiz/X_option.png');
    y_btn = loadImage('games/assets/quiz/Y_option.png');
    thank_you = loadImage('games/assets/quiz/thank_you.png');
    reset();
}
